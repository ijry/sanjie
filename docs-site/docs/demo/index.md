...
<div class="demo-layout">
  ...
  <div class="demo-panel">
    ...
    <h2>三界移动办公演示</h2>
    <p>内置完整 mock 数据，覆盖工作台、勾魂任务、投胎队列、审批中心、生死簿、十八层地狱、愿望工单、孟婆汤、审计日志和多角色切换。列表页与详情页均已做移动端高密度卡片展示，适合在文档站内嵌窗口直接演示。</p>
    <p>
...
- 勾魂管理：待执行、执行中、异常、已完成、已撤销任务均有多条样例。
- 投胎管理：排队、复核、已通过、待喝汤、已完成、已驳回流程均有多条样例。
- 生死簿：正常、预警、严重风险和冻结记录均有样例，详情页展示阳寿偏差、处置流程和审计记录。
- 十八层地狱：1 至 18 层容量、负载、设备状态和刑期记录完整展示，刑期详情支持发起复核。
- 愿望工单：求财、求学、姻缘、职场、健康、事业、运气等类型齐全，详情页支持转派、办结和驳回。
